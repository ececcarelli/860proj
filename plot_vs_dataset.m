function plot_vs_dataset(algorithms, param, N,d,magnitude, sig_x, sig_eps, param_start, param_end, tick_num, given_epochs, given_lambda, convergence_eps,title_str, num_tries)
...
for k=1:num_tries
    for j=1:tick_num
        ...
        for i =1:size(algorithms,2)
            ...
            scores(j,i+1) = scores(j,i+1) + gcount/num_tries;
            scores
        end
    end
end
