function[scores] = plot_vs_dataset(algorithms, param, N,d,magnitude, sig_x, sig_eps, t0, param_start, param_end, tick_num, linear, given_epochs, given_lambda, convergence_eps ,title_str, num_tries)
