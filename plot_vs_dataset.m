function[params, gcounts] = plot_vs_dataset(algorithms, param, N,d,magnitude, sig_x, sig_eps, param_start, param_end, tick_num, given_epochs, given_lambda, convergence_eps,title_str)
