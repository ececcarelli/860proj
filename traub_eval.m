[X, y, opt] = make_benchmark(1000, [10, -20, 30, -40, 50], 1, 1, -1, 1000, 65, 500)
w_opt = ((X' * X) \ (X' * y))';
min_err = evaluate_obj_fun(X, y, w_opt, 0);
rslt = plot_learning_curves(X,y,opt,{'sgd', 'svrg', 'saga'},200,1,'Iterations vs Value of Optimized Function',true)
figure (1)
hold on;
