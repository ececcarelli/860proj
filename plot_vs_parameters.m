...
for i =1:size(algorithms,2)
    [scores, cfrs] = hp_plot_input(X, y, algorithms(i),param_name, param_start, param_end, tick_num, given_epochs, given_lambda, given_t0, given_m, num_trials, convergence_eps);
    if use_log
